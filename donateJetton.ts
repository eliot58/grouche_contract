...
async function main() {
    ...
    const buildForwardPayload = (signedDataCell: Cell) => {
    ...
    const forwardPayload = buildForwardPayload(signedDataCell);

    const body = beginCell()
        .storeUint(0x0f8a7ea5, 32)
        .storeUint(0, 64)
        .storeCoins(atomic)
        .storeAddress(Address.parse("kQA-CIjW0SW6rXGyZmpUQNwIWHsAHxIw1QnvGE633HLMPBv5"))
        .storeAddress(beneficiary)
        .storeBit(0)
