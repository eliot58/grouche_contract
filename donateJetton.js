...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var buf, secretKey, initiativeId, beneficiary, expiredAt, amount, vesting_period, comment, signCell, buildForwardPayload, atomic, signedDataCell, forwardPayload, body;
        return __generator(this, function (_a) {
            ...
            body = (0, core_1.beginCell)()
                ...
                .storeUint(0, 64)
                .storeCoins(atomic)
                .storeAddress(core_1.Address.parse("kQA-CIjW0SW6rXGyZmpUQNwIWHsAHxIw1QnvGE633HLMPBv5"))
                .storeAddress(beneficiary)
                .storeBit(0)
